...
class CodeReviewer:
    def __init__(self, top_k=5, model_name='mistral', use_ollama=False, use_rag=True, use_yes_no=True, github_bot=False, use_train_store=False):
        self.top_k = top_k
    ...
    def is_review_needed(self, patch: str, return_prompt=False):
        prompt = ''
    ...
    def generate_review_comment(self, patch: str, return_prompt=False):
        prompt = ''
        ...
        if return_prompt:
            return json_response['reviewComment'], prompt
